...
public class BaiTap1Main {
    ...
    public static void main(String[] args) throws ParseException
    {
        ...
        HoaDonHeader hdh = new HoaDonHeader.Builder()
                .addmaHoaDon("HD007")
                .addngayBan(sdf.parse("26/05/2019"))
                .addtenKhachHang("Vũ Ngọc Đoàn")
                .build();
        
        CTHD ct1 = new CTHD.Builder()
                .addsanPham("Tivi LCD Samsung 49 Inches")
                .addsoLuong(1)
                .adddonGia(15000000)
                .addchietKhau(10)
                .build();
        ...
        CTHD ct3 = new CTHD.Builder()
                .addsanPham("Chuối Hột Phú Yên Tươi Mát")
                .addsoLuong(20)
                .adddonGia(10000)
                .addchietKhau(5)
                .build();
